// Clinqoo Blog — artikel deploy tambahan 2026-09-19 (merge ke data_deploy)
(function(){
  var extra = [
    {
    ...
    },
    {
      ...
      langs: {
        "id": {
          ...
          desc: "Situs Clinqoo yang berat di layar pertama membuat pengunjung mundur. Cek gambar dan skrip sebelum merayakan rilis.",
