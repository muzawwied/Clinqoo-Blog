// Clincoo Blog — Data kategori: deploy
// File ini di-generate otomatis. Jangan edit manual.

if (typeof window.countryDataFiles === 'undefined') window.countryDataFiles = {};

window.countryDataFiles["deploy"] = {
  names: { "id": "Deploy", "en": "Deploy" },
  flag: "🚀",
  articles: [
    {
      id: "deploy-situs-pertama",
      langs: {
        "id": {
          title: "Deploy Situs Pertamamu ke Internet dalam Hitungan Menit",
          desc: "Dari editor ke alamat yang bisa dibuka siapa saja — begini cara menerbitkan situs lewat menu Deploy Clincoo.",
          content: "<p class=\"mb-4\">Momen favorit setiap pemula: melihat situsnya sendiri online, bisa dibuka siapa saja di mana saja. Di Clincoo, momen itu tidak butuh konfigurasi rumit — deploy sudah jadi bagian dari alur kerja editor.</p><p class=\"mb-4\">Alurnya: pastikan semua perubahan sudah tersimpan, buka menu Deploy, lalu terbitkan. Clincoo memproses berkas-berkas proyekmu dan menyiapkannya sebagai situs statis di jaringan global — sehingga pengunjung dari berbagai wilayah memuatnya dari lokasi terdekat mereka.</p><p class=\"mb-4\">Setelah tayang, simpan alamat situsmu dan bagikan. Kalau nanti kamu mengubah kode, cukup deploy ulang — versi terbaru menggantikan yang lama. Tidak ada proses mulai dari awal; deploy adalah tombol ulang yang bisa kamu tekan kapan saja.</p><p class=\"mb-4\">Satu tips terakhir: sebelum deploy, buka pratinjau dan cek tampilannya di ukuran layar HP. Kebanyakan pengunjung pertamamu datang dari ponsel, dan kamu ingin kesan pertama yang terbaik.</p>",
          source: "Clincoo", sourceUrl: "https://app.clincoo.buzz/", sourceSnippet: "Menu Deploy Clincoo",
          source2: "Cloudflare Docs", sourceUrl2: "https://developers.cloudflare.com/pages/", sourceSnippet2: "Cara kerja hosting statis global",
          source3: "web.dev", sourceUrl3: "https://web.dev/learn/performance/", sourceSnippet3: "Dasar performa web"
        },
        "en": {
          title: "Deploy Your First Site to the Internet in Minutes",
          desc: "From editor to an address anyone can open — here is how publishing works through the Clincoo Deploy menu.",
          content: "<p class=\"mb-4\">Every beginner’s favorite moment: seeing their own site online, openable by anyone anywhere. In Clincoo that moment needs no complicated setup — deploying is simply part of the editor workflow.</p><p class=\"mb-4\">The flow: make sure your changes are saved, open the Deploy menu, then publish. Clincoo processes your project files and serves them as a static site on a global network — so visitors from different regions load your site from the location nearest to them.</p><p class=\"mb-4\">Once live, save your site’s address and share it. Later code changes? Just deploy again — the new version replaces the old. There is no starting over; deploy is a repeat button you can press anytime.</p><p class=\"mb-4\">One last tip: before deploying, open the preview and check how it looks on a phone-sized screen. Most of your first visitors arrive on mobile, and you want the best first impression.</p>",
          source: "Clincoo", sourceUrl: "https://app.clincoo.buzz/", sourceSnippet: "Menu Deploy Clincoo",
          source2: "Cloudflare Docs", sourceUrl2: "https://developers.cloudflare.com/pages/", sourceSnippet2: "Cara kerja hosting statis global",
          source3: "web.dev", sourceUrl3: "https://web.dev/learn/performance/", sourceSnippet3: "Dasar performa web"
        }
    ...
    {
      id: "domain-kustom-dan-dns",
      langs: {
        "id": {
          title: "Pakai Domain Sendiri: Dasar-dasar DNS untuk Pemilik Situs",
          desc: "Alamat domain sendiri membuat situsmu terdengar serius. Ini yang perlu kamu tahu sebelum memakainya.",
          content: "<p class=\"mb-4\">Situs yang baru dideploy punya alamat bawaan — praktis untuk dibagikan ke teman. Tapi saat situsmu mulai serius, domain sendiri seperti namakamu.com memberi kesan profesional dan mudah diingat.</p><p class=\"mb-4\">Cara kerjanya sederhana: kamu membeli domain dari penyedia domain, lalu menghubungkannya ke hosting situsmu lewat pengaturan DNS — semacam buku telepon internet yang memberi tahu ke mana setiap pengunjung harus diarahkan. Perubahan DNS biasanya butuh beberapa menit hingga beberapa jam untuk aktif.</p><p class=\"mb-4\">Yang penting dipahami pemula: domain dan hosting adalah dua barang terpisah. Domain adalah alamatnya, hosting adalah rumahnya. Kamu bisa ganti yang satu tanpa menyentuh yang lain — situsmu tidak hilang.</p><p class=\"mb-4\">Kalau bingung memulai, gunakan dulu alamat bawaan, dan naik ke domain sendiri saat situsmu sudah cukup sering dikunjungi. Tidak ada aturan yang menyuruh buru-buru — yang penting situsmu tayang dan terus berkembang.</p>",
          source: "Cloudflare Docs", sourceUrl: "https://developers.cloudflare.com/dns/", sourceSnippet: "Penjelasan DNS",
          source2: "MDN Web Docs", sourceUrl2: "https://developer.mozilla.org/docs/Glossary/DNS", sourceSnippet2: "Istilah DNS untuk pemula",
          source3: "Clincoo", sourceUrl3: "https://app.clincoo.buzz/", sourceSnippet3: "Menu Deploy Clincoo"
        },
        "en": {
          title: "Using Your Own Domain: DNS Basics for Site Owners",
          desc: "A custom domain makes your site sound serious. Here is what to know before using one.",
          content: "<p class=\"mb-4\">A freshly deployed site gets a default address — handy for sharing with friends. But once your site gets serious, your own domain like yourname.com adds a professional, memorable touch.</p><p class=\"mb-4\">It works simply: you buy a domain from a domain registrar, then connect it to your hosting through DNS settings — the internet’s phone book that tells every visitor where to be sent. DNS changes usually take effect within minutes to a few hours.</p><p class=\"mb-4\">What beginners must understand: a domain and hosting are two separate things. The domain is the address, hosting is the house. You can replace either one without touching the other — your site does not disappear.</p><p class=\"mb-4\">If you feel unsure, use the default address first and move to a custom domain once your site gains regular visitors. No rule says rush — what matters is that your site is live and keeps growing.</p>",
          source: "Cloudflare Docs", sourceUrl: "https://developers.cloudflare.com/dns/", sourceSnippet: "Penjelasan DNS",
          source2: "MDN Web Docs", sourceUrl2: "https://developer.mozilla.org/docs/Glossary/DNS", sourceSnippet2: "Istilah DNS untuk pemula",
          source3: "Clincoo", sourceUrl3: "https://app.clincoo.buzz/", sourceSnippet3: "Menu Deploy Clincoo"
        }
