// Clincoo Blog — artikel deploy tambahan (extra3)
(function(){
  var extra = [
    {
      ...
      langs: {
        "id": {
          title: "Tunggu Cache Reda setelah Deploy Clincoo, Baru Bagikan Tautan",
        ...
        "en": {
          title: "Wait for Cache after a Clincoo Deploy before Sharing the Link",
