// Clinqoo Blog — artikel legal tambahan extra4 2026-09-19
(function(){
  var extra = [
    {
      ...
      langs: {
        ...
        "en": {
          title: "Clinqoo User Content Copyright Policy",
          desc: "You keep ownership of the text, images, and code you upload. Clinqoo only takes a limited license to run the service.",
          content: "<p class=\"mb-4\">Content you write or upload into a Clinqoo project stays yours, provided it is yours to use. Updated: 19 September 2026.</p><h2>What you own</h2><p class=\"mb-4\">Text, images, licensed fonts you add, and custom code in the project belong to the account that uploaded them, unless a third-party license says otherwise.</p><h2>Limited license to Clinqoo</h2><p class=\"mb-4\">By using the service you grant Clinqoo a limited permission to store, preview, and publish the site as you instruct. That permission is not a transfer of copyright.</p><h2>What you must not upload</h2><p class=\"mb-4\">Do not upload other people’s work without permission, malware, or material that breaks applicable law. We may disable a project when a copyright report is well founded.</p><h2>Questions</h2><p class=\"mb-4\">Copyright questions go to <a href=\"mailto:muzawwied@gmail.com\">muzawwied@gmail.com</a>.</p>",
